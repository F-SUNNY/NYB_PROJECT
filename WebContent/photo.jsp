...
<body>
    ...
    <section class="shop">
        ...
        <div class="category">
            <ul>
                <li><a href="#" class="cate">PHOTO</a></li>
        ...
        <div class="product">
            <div class="photo">
                ...
                <h1 class="products">GUCCI</h1>
                <h1 class="price">이지금님</h1>
            </div>
            <div class="photo">
                <div class="hd">
                    <img class="gallery" src="resources/images/chang.jpg" alt="no">
                </div>
                <h1 class="products">D&G</h1>
                <h1 class="price">창모님</h1>
            </div>
            <div class="photo">
                <div class="hd">
                    <img class="gallery" src="resources/images/rd.jpg" alt="no">
                </div>
                <h1 class="products">APC</h1>
                <h1 class="price">레디님</h1>
            </div>
        </div>
    </section>
