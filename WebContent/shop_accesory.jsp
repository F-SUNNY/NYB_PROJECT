...
<body>
    ...
    <section class="shop">
        ...
        <%@ include file="dbconn.jsp" %>
				...
				String sql = "select * from product where category = 'accesory'";
            ...
            <div class="photo">       
                ...
                <h1 class="price"><a href="product.jsp?id=<%=rs.getString("productid")%>" role="button"><%=rs.getString("price")%>원</a></h1>
            </div>
               <%
				}
				if (rs != null)
